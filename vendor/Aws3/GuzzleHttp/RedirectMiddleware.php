...
use DeliciousBrains\WP_Offload_S3\Aws3\GuzzleHttp\Exception\BadResponseException;
use DeliciousBrains\WP_Offload_S3\Aws3\GuzzleHttp\Exception\TooManyRedirectsException;
