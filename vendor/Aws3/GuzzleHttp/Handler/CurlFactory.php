...
use DeliciousBrains\WP_Offload_S3\Aws3\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \DeliciousBrains\WP_Offload_S3\Aws3\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \DeliciousBrains\WP_Offload_S3\Aws3\GuzzleHttp\Psr7\Utils::streamFor($sink);
