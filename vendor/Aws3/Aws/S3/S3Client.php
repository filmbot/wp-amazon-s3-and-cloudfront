...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\AwsClient;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\CacheInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\ClientResolver;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Command;
...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Identity\S3\S3ExpressIdentityProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\InputValidationMiddleware;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Middleware;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\ResultInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Retry\QuotaManager;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\RetryMiddleware;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\RetryMiddlewareV2;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\S3\RegionalEndpoint\ConfigurationProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\S3\UseArnRegion\Configuration;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\S3\UseArnRegion\ConfigurationInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\S3\UseArnRegion\ConfigurationProvider as UseArnRegionConfigurationProvider;
...
class S3Client extends AwsClient implements S3ClientInterface
{
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        $request = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\serialize($command);
    ...
    {
        if ($value) {
            $config = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\Retry\ConfigurationProvider::unwrap($value);
