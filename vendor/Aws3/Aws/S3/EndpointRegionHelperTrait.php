...
trait EndpointRegionHelperTrait
{
    ...
    {
        $arnRegion = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\strip_fips_pseudo_regions(\strtolower($arnRegion));
    ...
    private function validateFipsConfigurations(ArnInterface $arn)
    {
        ...
        if ($arn instanceof OutpostsArnInterface) {
            ...
            if (\DeliciousBrains\WP_Offload_S3\Aws3\Aws\is_fips_pseudo_region($region)) {
