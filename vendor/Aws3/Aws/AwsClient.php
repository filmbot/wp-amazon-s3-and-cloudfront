...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointV2\EndpointProviderV2;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointV2\EndpointV2Middleware;
...
class AwsClient implements AwsClientInterface
{
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
