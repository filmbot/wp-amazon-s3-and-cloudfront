...
namespace DeliciousBrains\WP_Offload_S3\Aws3\Aws\Endpoint\UseDualstackEndpoint;

use DeliciousBrains\WP_Offload_S3\Aws3\Aws\AbstractConfigurationProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\CacheInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\ConfigurationProviderInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Endpoint\UseDualstackEndpoint\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($region, $profile = null, $filename = null)
    {
        ...
        return function () use($region, $profile, $filename) {
            ...
            $data = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\parse_ini_file($filename, \true, \INI_SCANNER_NORMAL);
            if ($data === \false) {
