...
use DeliciousBrains\WP_Offload_S3\Aws3\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    public static function defaultProvider($options = [])
    {
        ...
        $prefixData = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
