...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\ClientSideMonitoring\Configuration;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Configuration\ConfigurationResolver;
...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointDiscovery\ConfigurationInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointDiscovery\ConfigurationProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointV2\EndpointDefinitionProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Exception\AwsException;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Exception\InvalidRegionException;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Signature\SignatureProvider;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Token\Token;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Token\TokenInterface;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Token\TokenProvider;
...
class ClientResolver
{
    ...
    {
        return ConfigurationResolver::resolve('disable_request_compression', \false, 'bool', $args);
    }
    ...
    public static function _apply_token($value, array &$args)
    {
        ...
        if ($value instanceof Token) {
            ...
            $args['token'] = TokenProvider::fromToken(new Token($value['token'], isset($value['expires']) ? $value['expires'] : null));
        } elseif ($value instanceof CacheInterface) {
    ...
    {
        if ($value === \false) {
            $value = new Configuration(\false, \DeliciousBrains\WP_Offload_S3\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST, \DeliciousBrains\WP_Offload_S3\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT, \DeliciousBrains\WP_Offload_S3\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID);
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider($value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            if ($value instanceof \DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointV2\EndpointProviderV2) {
            ...
            $args['region'] = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\strip_fips_pseudo_regions($args['region']);
    ...
    public static function _apply_user_agent($inputUserAgent, array &$args, HandlerList $list)
    {
        ...
        if (\defined('DeliciousBrains\\WP_Offload_S3\\Aws3\\HHVM_VERSION')) {
        ...
        if (isset($args['endpoint_discovery'])) {
            if ($args['endpoint_discovery'] instanceof \DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointDiscovery\Configuration && $args['endpoint_discovery']->isEnabled()) {
        ...
        if (isset($args['retries'])) {
            if ($args['retries'] instanceof \DeliciousBrains\WP_Offload_S3\Aws3\Aws\Retry\Configuration) {
    ...
    public static function _default_endpoint_provider(array $args)
    {
        ...
        if (self::isValidService($serviceName) && self::isValidApiVersion($serviceName, $apiVersion)) {
            ...
            return new \DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointV2\EndpointProviderV2($ruleset, EndpointDefinitionProvider::getPartitions());
        }
        $options = self::getEndpointProviderOptions($args);
    ...
    {
        return ConfigurationResolver::resolve('ignore_configured_endpoint_urls', \false, 'bool', $args);
    }
    public static function _default_endpoint(array &$args)
    {
        ...
        $serviceIdentifier = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\manifest($args['service'])['serviceIdentifier'];
...
EOT;
    ...
    private function _apply_client_context_params(array $args)
    {
        if (isset($args['api']) && !empty($args['api']->getClientContextParams())) {
            ...
            foreach ($clientContextParams as $paramName => $paramDefinition) {
                $definition = ['type' => 'value', 'valid' => [$paramDefinition['type']], 'doc' => isset($paramDefinition['documentation']) ? $paramDefinition['documentation'] : null];
    ...
    private static function isValidService($service)
    {
        ...
        $services = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\manifest();
