...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Exception\UnresolvedSignatureException;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Token\BearerTokenAuthorization;
/**
 * Signature providers.
 *
