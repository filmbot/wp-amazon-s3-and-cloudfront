...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Signature\SignatureV4;
...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(AwsClientInterface $client, CommandInterface $cmd)
    {
        ...
        if ($this->endpointProvider instanceof \DeliciousBrains\WP_Offload_S3\Aws3\Aws\EndpointV2\EndpointProviderV2) {
