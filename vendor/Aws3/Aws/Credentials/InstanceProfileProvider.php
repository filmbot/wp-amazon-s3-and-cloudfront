...
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Exception\InvalidJsonException;
use DeliciousBrains\WP_Offload_S3\Aws3\Aws\Sdk;
use DeliciousBrains\WP_Offload_S3\Aws3\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = $config['client'] ?? \DeliciousBrains\WP_Offload_S3\Aws3\Aws\default_http_handler();
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \DeliciousBrains\WP_Offload_S3\Aws3\Aws\default_user_agent();
    ...
    {
        $isImdsV1Disabled = \DeliciousBrains\WP_Offload_S3\Aws3\Aws\boolean_value($this->ec2MetadataV1Disabled) ?? \DeliciousBrains\WP_Offload_S3\Aws3\Aws\boolean_value(ConfigurationResolver::resolve(self::CFG_EC2_METADATA_V1_DISABLED, self::DEFAULT_AWS_EC2_METADATA_V1_DISABLED, 'bool', ['use_aws_shared_config_files' => \true])) ?? self::DEFAULT_AWS_EC2_METADATA_V1_DISABLED;
